define(["require", "exports", "../libz3"], function (require, exports, libz3_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    registerTest("simple_contradiction_string", function test(wasmInstance) {
        ...
        var s1 = lib.Z3_mk_string_symbol(context, "a");
        console.log("s1: ", s1);
        var c1 = lib.Z3_mk_const(context, s1, int_sort);
        console.log("c1: ", c1);
        var s2 = lib.Z3_mk_string_symbol(context, "b");
        console.log("s2: ", s2);
